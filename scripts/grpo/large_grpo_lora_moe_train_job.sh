#!/bin/bash
#SBATCH --job-name=crrl-large-grpo-lora-moe
#SBATCH --output=logs/large_grpo_lora_moe_%j.out
#SBATCH --error=logs/large_grpo_lora_moe_%j.err
#SBATCH --nodes=1
#SBATCH --gpus 6
...
MODEL_CONFIG="${MODEL_CONFIG:-large_qwen_moe}"

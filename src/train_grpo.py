...
def main(cfg: Config) -> None:    
    ...
    if cfg.run.task_type == "repair":
        ...
        if cfg.run.task_type == "repo_repair_multilingual":  # a bit hacky
            dataset_a = get_swe_gym_repo_repair_dataset(dataset_name="SWE-Gym/SWE-Gym").select(1000)  # pick 1000
            dataset_b = get_swe_gym_repo_repair_dataset(dataset_name="SWE-bench/SWE-bench_Multilingual", holdout_ratio=1/6)  # use 250, leave 50 for evals
